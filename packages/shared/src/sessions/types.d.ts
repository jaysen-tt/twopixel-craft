 ...
 */
export declare const SESSION_PERSISTENT_FIELDS: readonly ["id", "workspaceRootPath", "sdkSessionId", "sdkCwd", "createdAt", "lastUsedAt", "lastMessageAt", "name", "isFlagged", "sessionStatus", "labels", "hidden", "lastReadMessageId", "hasUnread", "enabledSourceSlugs", "permissionMode", "previousPermissionMode", "workingDirectory", "model", "llmConnection", "connectionLocked", "thinkingLevel", "sharedUrl", "sharedId", "pendingPlanExecution", "isArchived", "archivedAt", "branchFromMessageId", "branchFromSdkSessionId", "branchFromSessionPath", "branchFromSdkCwd", "branchFromSdkTurnId", "transferredSessionSummary", "transferredSessionSummaryApplied", "triggeredBy"];
...
export interface SessionHeader {
    ...
    /** SDK session ID (captured after first message) */
    sdkSessionId?: string;
    /** Workspace root path (stored as portable path, e.g., ~/.twopixel/...) */
    workspaceRootPath: string;
    /** Optional user-defined name */
    name?: string;
    createdAt: number;
