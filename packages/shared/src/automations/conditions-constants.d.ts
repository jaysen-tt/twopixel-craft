 ...
 */
export declare const MAX_CONDITION_DEPTH_EXCLUSIVE = 8;
/** Emit simplification warnings when condition depth exceeds this threshold. */
export declare const CONDITION_DEPTH_WARNING_THRESHOLD = 4;
//# sourceMappingURL=conditions-constants.d.ts.map