...
> **CLI-first workflow (recommended):** Use `twopixel permission ...` commands instead of editing JSON directly.
> - `twopixel permission --help`
...
- Source: `~/.twopixel/workspaces/{slug}/sources/{source}/permissions.json`
