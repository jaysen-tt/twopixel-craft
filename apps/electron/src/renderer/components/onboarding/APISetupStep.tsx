...
const SEGMENT_DESCRIPTIONS: Record<ProviderSegment, React.ReactNode> = {
  ...
  pi: <>Use TwoPixel Backend as the main agent.<BetaBadge /><br />Configure with your API key, OAuth subscription, or custom endpoint.</>,
}
...
const API_SETUP_OPTIONS: ApiSetupOption[] = [
  ...
  },
  {
    id: 'pi_chatgpt_oauth',
    name: 'ChatGPT Plus',
    description: 'Use your ChatGPT subscription with TwoPixel Backend.',
  ...
  },
  {
    id: 'pi_copilot_oauth',
    name: 'GitHub Copilot',
    description: 'Use your GitHub Copilot subscription with TwoPixel Backend.',
    icon: <Cpu className="size-4" />,
    providerType: 'pi',
  },
  {
    id: 'pi_api_key',
    name: 'API Key',
    description: 'Use provider presets (Anthropic, OpenAI, Google, etc.) via TwoPixel Backend.',
    icon: <Key className="size-4" />,
    providerType: 'pi',
  },
]
