...
export async function rebuildMenu(): Promise<void> {
  ...
  // Users access menu via the TwoPixel logo dropdown in the app
  if (!isMac) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    ...(isMac ? [{
      label: 'TwoPixel',
      submenu: [
        { role: 'about' as const, label: 'About TwoPixel' },
        updateMenuItem,
        ...
        { type: 'separator' as const },
        { role: 'hide' as const, label: 'Hide TwoPixel' },
        { role: 'hideOthers' as const },
        { role: 'unhide' as const },
        { type: 'separator' as const },
        { role: 'quit' as const, label: 'Quit TwoPixel' }
      ]
    }] : []),
